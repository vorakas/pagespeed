...
test("requestStatGroupName normalizes known request labels", () => {
...
test("buildRequestStatGroups skips non-page labels", () => {
  assert.deepEqual(
...
test("buildRequestStatGroups preserves explicit grouped rows", () => {
...
test("buildRequestStatGroups rolls child labels into a parent aggregate", () => {
  const rolled = buildRequestStatGroups([
    {
      labelId: 1,
      labelName: "SFP: 1905N",
      samples: 10,
